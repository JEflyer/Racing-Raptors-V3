...
library gameLib {
    ...
    function setStat(address _stat) internal {
        ...
        returns (bool)
    {
        ...
        return IStats(store.statContract).checkApproval(minterIndex, raptor);
    }
        ...
        returns (GameVars memory)
    {
        ...
        if (index == gameVars.fighters[0]) {
            ...
            if (!gameVars.dr) {
                ...
                emit RipRaptor(gameVars.minterIndexes[gameVars.fighters[1]], gameVars.raptors[gameVars.fighters[1]]);
            }
    ...
    function upgradeStrength(GameVars memory gameVars) internal {
        ...
        bool success = IStats(stat).upgradeStrength(
    ...
    function upgradeSpeed(GameVars memory gameVars) internal {
        ...
        bool success = IStats(stat).upgradeSpeed(
    ...
    function increaseQPWins(GameVars memory gameVars) internal {
        ...
        bool success = IStats(stat).upgradeQPWins(
            gameVars.minterIndexes[gameVars.polaces[0]],
            gameVars.raptors[gameVars.places[0]]
        );
    ...
    function increaseCompWins(GameVars memory gameVars) internal {
        ...
        bool success = IStats(stat).upgradeCompWins(
            gameVars.minterIndexes[gameVars.places[0]],
            gameVars.raptors[gameVars.places[0]]
        );
    ...
    function increaseDeathRaceWins(GameVars memory gameVars) internal {
        ...
        bool success = IStats(stat).upgradeDRWins(
            gameVars.minterIndexes[gameVars.places[0]],
            gameVars.raptors[gameVars.places[0]]
        );
    ...
    function increaseTop3RaceFinishes(GameVars memory gameVars) internal {
        ...
        for (uint8 i = 0; i < 3; ) {
            ...
            bool success = IStats(stat).upgradeTop3Finishes(
        ...
        returns (uint8, uint16)
    {
        ...
        return (gameVars.minterIndexes[gamVars.places[0]]), gameVars.raptors[gameVars.places[0]]);
    }
    ...
    function _kill(uint16 raptor) internal {
        ...
        //Burn the raptor
        IStats(store.statContract).burn(raptor);
    }
