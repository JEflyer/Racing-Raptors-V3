...
contract GameV3 is IERC721Receiver, Context, RND {
    ...
    function fulfillRandomnWords(
        bytes32 requestId,
        uint256[8] memory randomness
    ) internal override {
        ...
        if (uint8(currentRace) == 1) {
            ...
            (winner, minterIndex) = gameLib._quickPlayStart(
            ...
            (winner, minterIndex) = gameLib._compStart(
            ...
            (winner, minterIndex) = gameLib._deathRaceStart(
